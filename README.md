...
GEMINI_API_KEY="..."                # For style analysis (optional)
```
...
- **AI Style Analysis** — Gemini analyzes your wardrobe and returns a style profile, category balance, color palette insights, gap recommendations, and seasonal coverage.
